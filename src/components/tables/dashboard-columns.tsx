...
import { deleteDashboardAction } from '@/actions/admin/powerbi/delete-dashboard'
				...
				try {
					...
					if (result.error) {
						toast.error('Error al eliminar dashboard', {
							description: result.error || 'No se pudo eliminar el dashboard del sistema',
						})
						throw new Error(result.error || 'Error al eliminar dashboard')
					}
					...
					if (
						!(
							...
							error.message.includes('Error al eliminar dashboard')
						)
					) {
