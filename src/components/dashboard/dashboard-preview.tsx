...
export function DashboardPreview({
	...
	if (!hasAccess) {
		return (
			<div
				className={`h-48 ${className} border border-dashed rounded-lg bg-gray-50 flex items-center justify-center relative overflow-hidden`}
			>
	...
	if (!iframeHtml) {
		return (
			<div
				className={`h-48 ${className} border border-dashed rounded-lg bg-gray-50 flex items-center justify-center`}
			>
	...
	return (
		<div
			className={`h-48 ${className} relative overflow-hidden rounded-lg border bg-white`}
		>
			{/* Category badge */}
			{category && (
				<Badge
